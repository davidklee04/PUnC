...
`define START_TEST(NAME)                                                    \
	begin                                                                   \
		...
		$display("----------------------------");                           \
		#1;                                                                 \
		$readmemh({"/home/dl1506/punc/images/", (NAME), ".vmh"}, punc.dpath.mem.mem, 0, 127); \
		rst = 1;                                                            \
		@(posedge clk);                                                     \
		#1;                                                                 \
		rst = 0;                                                            \
...
//		`ASSERT_MEM_EQ(23, 16'd3);
		 ...
		 // ADD YOUR TEST HERE!
		`START_TEST("insertionSort");
		`WAIT_PC_FREEZE;
		`ASSERT_REG_EQ(0, 16'd26); // array address
		`ASSERT_REG_EQ(7, 16'd5); // array length
		`ASSERT_REG_EQ(1, 16'd31); // (last memory address of the array) + 1
		`ASSERT_REG_EQ(2, 16'd31); // pointer i should end here

		`ASSERT_MEM_EQ(26, 16'd5);
		`ASSERT_MEM_EQ(27, 16'd6);
		`ASSERT_MEM_EQ(28, 16'd11);
		`ASSERT_MEM_EQ(29, 16'd12);
		`ASSERT_MEM_EQ(30, 16'd13);
